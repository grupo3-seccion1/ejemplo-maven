...
node {
    ...
    try {
        ...
        stage('Upload Nexus'){
            ...
            nexusPublisher nexusInstanceId: 'nexus01', nexusRepositoryId: 'devops-usach-nexus', packages: [[$class: 'MavenPackage', mavenAssetList: [[classifier: '', extension: '', filePath: './build/DevOpsUsach2020-0.0.1.jar']], mavenCoordinate: [artifactId: 'DaniloVidal', groupId: 'com.devopsusach2020', packaging: 'jar', version: '0.0.1']]]
        ...
        stage('Download Nexus Artefact'){
            ...
            sh 'curl -X GET -u admin:1qazxsw2 https://nexus.danilovidalm.com/repository/devops-usach-nexus/com/devopsusach2020/DaniloVidal/0.0.1/DevOpsUsach2020-0.0.1.jar -O'
        }
    ...
    if(responseStatus == '200'){
        try {
            stage('Upload jar to Nexus'){
                ...
                nexusPublisher nexusInstanceId: 'nexus01', nexusRepositoryId: 'devops-usach-nexus', packages: [[$class: 'MavenPackage', mavenAssetList: [[classifier: '', extension: '', filePath: './DevOpsUsach2020-0.0.1.jar']], mavenCoordinate: [artifactId: 'DaniloVidal', groupId: 'com.devopsusach2020', packaging: 'jar', version: '1.0.0']]]
